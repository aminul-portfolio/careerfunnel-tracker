...
def render_careerfunnel_evidence_summary() -> list[str]:
    lines = ["## CareerFunnel Evidence Summary", "", CAREERFUNNEL_EVIDENCE_SUMMARY[0], ""]
    for bullet in CAREERFUNNEL_EVIDENCE_SUMMARY[1:]:
...
def render_report(result: AuditResult) -> str:
    ...
    lines = [
        ...
        "",
        *render_careerfunnel_evidence_summary(),
        "## Project Summary",
        "",
