...
urlpatterns = [
    ...
    path(
        ...
        views.interview_prep_generator,
    ...
    path(
        ...
        views.cover_letter_quality_checker,
        name="cover_letter_quality_checker",
    ),
    path(
        "rejection-pattern-analyzer/",
        views.rejection_pattern_analyzer,
        name="rejection_pattern_analyzer",
    ),
