...
class Sprint105EPhase1BAiCapabilityFrameworkWorkflowNavTests(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            username="cf105e-framework-nav-user",
            password="StrongPass12345",
        )
        self.url = reverse("skills:ai_capability_framework")

    def _get(self):
        self.client.login(username="cf105e-framework-nav-user", password="StrongPass12345")
        return self.client.get(self.url)
    ...
    def test_manual_action_link_labels_present(self):
        ...
        self.assertIn(reverse("skills:ai_readiness_report"), content)
    ...
    def test_advisory_wording_preserved(self):
        ...
        self.assertContains(
            response,
            "Review each capability manually before citing it in applications or interviews.",
        )
