...
class NoteForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "title": forms.TextInput(attrs={"class": "form-control", "placeholder": "Example: Changed CV headline"}),
            "content": forms.Textarea(attrs={"class": "form-control", "rows": 7}),
            "tags": forms.TextInput(attrs={"class": "form-control", "placeholder": "CV, LinkedIn, screening"}),
