...
class NoteModelTests(TestCase):
    ...
    def test_note_string_representation(self):
        note = Note.objects.create(
            ...
            title="Focus on junior Data Analyst roles",
            content="Avoid senior roles for now.",
        )
    ...
    def test_tag_list_returns_clean_tags(self):
        note = Note.objects.create(
            user=self.user,
            title="CV Update",
            content="Updated CV headline.",
            tags="CV, LinkedIn, screening ",
        )
...
class NoteViewTests(TestCase):
    ...
    def test_user_can_create_note(self):
        ...
        response = self.client.post(
            ...
            {
                "note_type": NoteType.CV_CHANGE,
                "title": "Updated CV headline",
                "content": "Changed headline to Data Analyst focused version.",
                "tags": "CV, LinkedIn",
