...
**Sprint 55 (feature branch `sprint-55-job-to-ai-capability-matching`):** Job-to-AI Capability Matching - deterministic keyword matching service (`apps/skills/services/job_ai_capability_matching.py`), **12** new matching tests; evidence doc `docs/evidence/sprint_55_job_to_ai_capability_matching.md`. Phase 1 service only; no UI, models/migrations, external AI calls, or automation.
