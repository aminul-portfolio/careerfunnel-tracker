...
Django job-search analytics: funnel metrics, source/CV performance, data-quality reporting, manual recruiter-email workflow (rule-based), workbook exports, and Career Evidence OS (V1-V6). Portfolio project with 320 passing tests -- not a live SaaS.
